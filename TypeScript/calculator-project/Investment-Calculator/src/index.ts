...
const initialAmountEl = document.querySelector("#initial-amount") as HTMLInputElement;
const yearlyContributionEl = document.querySelector("#yearly-contribution") as HTMLInputElement;
const expectedReturnEl = document.querySelector("#expected-return") as HTMLInputElement;
const durationEl = document.querySelector("#duration") as HTMLInputElement;

const form = document.querySelector("form");
const appDiv = document.getElementById("app");

function renderResults(results: CalculateResult) {
